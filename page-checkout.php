              ...
              <div class="block block-rounded">
                ...
                <div class="block-content block-content-full space-y-3">
                  <div class="form-check form-block">
                    <input type="radio" class="form-check-input" id="checkout-delivery-1" name="checkout-delivery"
                      checked>
                    <label class="form-check-label" for="checkout-delivery-1">
                      <span class="d-block fw-normal p-1">
                        ...
                        <span class="d-block fs-sm fw-medium text-muted"><span class="fw-semibold">FREE</span> (4-5
                          working days)</span>
                      </span>
                    </label>
                  </div>
                  <div class="form-check form-block">
                    ...
                    <label class="form-check-label" for="checkout-delivery-2">
                      <span class="d-block fw-normal p-1">
                        ...
                        <span class="d-block fs-sm fw-medium text-muted"><span class="fw-semibold">+$9.99</span> (1-2
                          working days)</span>
                      </span>
                    </label>
                  </div>
                ...
                <div class="block-content block-content-full">
                  <div class="row g-3">
                    <div class="col-6 col-sm-2">
                      <div class="form-check form-block">
                        <input type="radio" class="form-check-input" id="checkout-payment-1" name="checkout-payment"
                          checked>
                          ...
                          <span class="d-block p-1 ratio ratio-21x9">
                            <svg class="d-inline-block" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <path
                                ...
                                style="fill:#faa61a" transform="matrix(4.42996 0 0 4.42996 -81.166 -105.048)" />
                            </svg>
                          </span>
                        </label>
                      </div>
                          ...
                          <span class="d-block p-1 ratio ratio-21x9">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 997.517">
                              ...
                              <path
                                ...
                                style="fill:#fff;stroke:none" transform="translate(-55.5 -1002.345)" />
                              <path
                  ...
                  <div class="p-3 rounded-3 bg-body-light">
                    <div class="mb-4">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="payment-card-number" name="payment-card-number"
                          placeholder="**** **** **** ****">
                    ...
                    <div class="row mb-4">
                      <div class="col-6">
                        <div class="form-floating">
                          <input type="text" class="form-control" id="payment-expriration" name="payment-expriration"
                            placeholder="MM / YY">
                    ...
                    <div>
                      <div class="form-floating">
                        <input type="text" class="form-control" id="payment-card-name" name="payment-card-name"
