                  ...
                  <div class="p-3 rounded-3 bg-body-light">
                    <div class="mb-4">
                      <div class="form-floating">
                        ...
                        <label class="form-label" for="payment-card-number"><?php _e('Número do Cartão', 'mt-area'); ?></label>
                      </div>
                    </div>
                    <div class="row mb-4">
                      <div class="col-6">
                        <div class="form-floating">
                          ...
                          <label class="form-label" for="payment-expriration"><?php _e('MM / YY', 'mt-area'); ?></label>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-floating">
                          <input type="text" class="form-control" id="payment-cvc" name="payment-cvc" placeholder="***">
                          <label class="form-label" for="payment-cvc"><?php _e('CVC', 'mt-area'); ?></label>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div class="form-floating">
                        <input type="text" class="form-control" id="payment-card-name" name="payment-card-name" placeholder="Insira seu nome">
                        <label class="form-label" for="payment-card-name"><?php _e('Nome no Cartão', 'mt-area'); ?></label>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                  <table class="table table-vcenter">
                    ...
                    <tbody>
                      <tr>
                        <td class="ps-0 fw-medium"><?php _e('Subtotal', 'mt-area'); ?></td>
                        <td class="pe-0 fw-medium text-end">R$ 329,70</td>
                      </tr>
                      <tr>
                        <td class="ps-0 fw-medium"><?php _e('Cupom de Desconto', 'mt-area'); ?></td>
                        <td class="pe-0 fw-medium text-end">- R$ 30,00</td>
                      </tr>
                      <tr>
                        <td class="ps-0 fw-medium"><?php _e('Total', 'mt-area'); ?></td>
                        <td class="pe-0 fw-bold text-end">R$ 299,70</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
