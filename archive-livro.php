...
<main id="main-container">
  ...
  <!-- Hero -->
  <div class="bg-image bg-image-fixed" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/media/mt/qm_livros.jpg'; ?>');">
          ...
          <div class="col-xxl-6">
            <div class="block block-rounded border-start border-warning border-3 block-link-shadow">
              ...
              <div class="accordion block-content block-content-full block-content-sm bg-body-light p-0" id="accordion<?php echo $i; ?>">
                <button id="book<?php echo $i; ?>" class="accordion-header accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $i; ?>" aria-expanded="false" aria-controls="collapse<?php echo $i; ?>">
                  <?php _e('Saiba Mais', 'mt-area'); ?> </button>
                <div id="collapse<?php echo $i; ?>" class="accordion-collapse collapse" aria-labelledby="book<?php echo $i; ?>" data-bs-parent="#accordion<?php echo $i; ?>" style="">
