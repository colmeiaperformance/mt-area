...
export default class Template {
  ...
  _uiHandleTheme() {
    let self = this;
    let themeEl = document.getElementById('theme-css');
    ...
    if (rememberTheme) {
      ...
      themeEl = document.getElementById('theme-css');
    } else {
  ...
  _uiUpdateTheme(themeEl, themeName) {
    if (themeName === 'default') {
      ...
      if (themeEl) {
        ...
        document.getElementById('main-css').insertAdjacentElement('afterend', themeLink);
      }
    }
  }
