...
function loading_styles()
{
    ...
    wp_enqueue_style('style-bootstrap', get_template_directory_uri() . '/vendor/bootstrap/bootstrap.min.css', array(), wp_get_theme()->get('Version'), 'all');
    wp_enqueue_style('icons-bootstrap', get_template_directory_uri() . '/vendor/bootstrap/bootstrap-icons.css', array(), wp_get_theme()->get('Version'), 'all');
