...
<body>
  <div id="login-section" class="hero-section">
      ...
      <div class="row align-items-center w-100">
        <div class="col-12 col-lg-6 gx-5 d-flex flex-column justify-content-around mt-5 mt-lg-0">
          <div class="hero-container mb-3 mb-lg-auto">
            <h1 class="hero-title text-center text-lg-start mb-3">
              <?php _e('Bem-vindo à Comunidade MT Brasil!', 'mt-area'); ?>
            </h1>
            <h2 class="hero-subtitle text-center text-lg-start">
              <?php _e('Área exclusiva aos praticantes da Meditação Transcendental', 'mt-area'); ?>
            </h2>
          </div>
        </div>
        <div class="col-12 col-lg-6 gx-5 px-md-4 mb-5 mb-lg-auto">
          <div class="shadow bg-white p-3 p-md-5 rounded mx-lg-5">
            <div id="login-container">
              <div class="img text-center mb-3">
                <img class="img-fluid w-25"
                  src="<?php echo get_template_directory_uri() . '/assets/media/mt/icon-arvore.png' ?>" alt="">
              </div>
              <form id="login-form" action="" method="post">
                <div class="mb-3">
                  <label class="form-label" for="username"><?php _e('Nome de Usuário ou Email:', 'mt-area');?></label>
                  <input class="form-control" type="text" name="username" id="username" required>
                </div>
                <div class="mb-3">
                  <label class="form-label" for="password"><?php _e('Senha:', 'mt-area');?></label>
                  <div class="pass-group">
                    <input class="form-control" type="password" name="password" id="password" required>
                    <span class="fa-solid fa-eye hidden-eye"></span>
                  </div>
                </div>
                <div class="mb-3">
            ...
            <?php endif; ?>
            <div class="mb-3">
              <a name="registerme" id="registerme" class="btn btn-primary w-100"
                href="<?php echo esc_url(wp_registration_url()); ?>" role="button"><?php _e('Primeiro acesso?
                Solicite seu login', 'mt-area'); ?></a>
            </div>
            <div class="mb-3">
              <a class="text-muted"
                href="<?php echo esc_url(wp_lostpassword_url()); ?>"><?php _e('Esqueceu sua senha?', 'mt-area'); ?></a>
            </div>
          </div>
        </div>
      </div> <!-- row -->
  ...
  <script>
  //Login password eye
  let passwordEye = document.querySelector(".hidden-eye");
